...
const NotificationItem = ({ notif, getIconBg, getIcon }) => {
    ...
    let displayMessage = notif.content;
    let workspaceId = notif.workspace_id;
    ...
    const handleNotificationClick = () => {
        ...
        switch (notif.type) {
            ...
            case 'task_assigned':
                navigate(`/home/workspace/${workspaceId}/overview`);
                break;
            case 'meeting_scheduled':
                navigate(`/home/workspace/${workspaceId}/meetings`);
                break;
            case 'meeting_started':
                navigate(`/home/workspace/${workspaceId}/meetings/${notif.relatedId}`);
                break;
            default:
                break;
        }
