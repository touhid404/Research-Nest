...
const MessagesBase = () => {
  ...
  return (
    <div className="h-full w-full bg-slate-100 dark:bg-slate-950 flex overflow-hidden relative isolate rounded-lg">
      ...
      <div className={`flex-1 h-full rounded-lg min-w-0 bg-transparent ${!selectedConversation ? "hidden md:block" : "block"}`}>
        <ChatInterface />
      </div>
