...
const RightSidebar = () => {
    return (
        <div className="lg:flex rn-scrollbar flex-col gap-4 p-2 w-[310px] h-screen 
            ...
            {/* Premium Card */}
            <div className="rounded-2xl p-4 gap-2 
                bg-gray-100 dark:bg-gray-800">
                <h2 className="font-bold text-xl">Get Premium for just A$1</h2>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                    It's Premium's 3rd birthday! Have the best of X from A$1 in your first month. Ends soon.
                </p>

                <button className="btn bg-black hover:bg-gray-800 
            ...
            <div className="rounded-2xl pt-4 
                ...
                <div className="hover:bg-gray-200 dark:hover:bg-gray-700 
                    ...
                    <div className="flex justify-between items-start">
                        <div className="text-xs text-gray-500 dark:text-gray-400">Sports · Trending</div>
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">40.8K posts</div>
                </div>
                ...
                <div className="hover:bg-gray-200 dark:hover:bg-gray-700 
                    p-4 cursor-pointer transition-colors duration-200">
                    <div className="flex justify-between items-start">
                        <div className="text-xs text-gray-500 dark:text-gray-400">Entertainment · Trending</div>
                        <FaEllipsisH className="text-gray-500 dark:text-gray-400 hover:text-primary" />
                    </div>
                    <div className="font-bold text-sm">
                        EmiBonnie Captivate Fans at Macau Blush Blossom Fest
                    </div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">23.1K posts</div>
                </div>
            ...
            <div className="rounded-2xl pt-4 
                ...
                <div className="hover:bg-gray-200 dark:hover:bg-gray-700 
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-sm hover:underline">Elon Musk</span>
                            <span className="text-gray-500 dark:text-gray-400 text-xs">@elonmusk</span>
                        </div>
                    </div>

                    <button className="btn btn-sm bg-black hover:bg-gray-800 
                        dark:bg-blue-600 dark:hover:bg-blue-500
                ...
                <div className="hover:bg-gray-200 dark:hover:bg-gray-700 
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="flex flex-col">
                            <span className="font-bold text-sm hover:underline">Lee Patriot</span>
                            <span className="text-gray-500 dark:text-gray-400 text-xs">@Mofoman360</span>
                        </div>
                    </div>
