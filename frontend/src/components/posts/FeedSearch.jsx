...
import { FaSearch, FaTimes, FaArrowRight, FaUserAlt } from "react-icons/fa";
        ...
        <div className="relative flex justify-end" ref={containerRef}>
            ...
            >
                ...
                <input
                    ref={inputRef}
                    type="text"
                    placeholder={isFocused || query ? "Search posts or people..." : "Search"}
                    value={query}
                    onChange={(e) => {
                                        ...
                                        {filteredPosts.map((post, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    ...
                                                    <span className="text-xs font-medium truncate flex-1 text-left">{post.title}</span>
                                ...
                                {filteredUsers.length > 0 && (
                                    <div>
                                        ...
                                        {filteredUsers.map((user, index) => {
                                            const globalIndex = filteredPosts.length + index;
                                            return (
                                                <button
                                                    key={user.uid}
