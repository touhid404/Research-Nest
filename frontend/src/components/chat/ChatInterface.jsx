        ...
        <div className="flex flex-col h-full relative">
            ...
            <div className="flex-none z-20 border-b border-gray-100 dark:border-slate-900 p-1.5 bg-transparent backdrop-blur-md">
                <div className="flex items-center gap-4">
                    ...
                    <div className="avatar placeholder relative group cursor-pointer">
                        ...
                        <div className="w-10 h-10 rounded-full ring ring-offset-2 ring-violet-500 ring-offset-base-100 transition-all duration-300 group-hover:scale-105">
                            {otherUser?.photoURL ? (
                                ...
                                <span className="text-lg font-bold bg-gradient-to-br from-violet-600 to-fuchsia-600 text-white flex items-center justify-center w-full h-full">
                    ...
                    <div>
                        <h3 className="font-bold text-base text-slate-800 dark:text-slate-100">{otherUser?.name}</h3>
                ...
                {messages.length === 0 ? (
                    <div className="flex flex-col items-center justify-center h-full text-center space-y-3 opacity-60">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400">Say hello to {otherUser?.name}</p>
                        </div>
                    </div>
                ) : (
                            ...
                            <div key={message._id}>
                                ...
                                <div className={`chat ${isOwnMessage ? "chat-end" : "chat-start"}`}>
                                    <div className="chat-image avatar">
                                        <div className="w-8 rounded-full border border-slate-200 dark:border-slate-700 shadow-sm">
                                            {isOwnMessage ? (
                                    ...
                                    <div className="chat-header text-[10px] opacity-50 mb-1 ml-1">
