...
import { BiDotsVerticalRounded, BiShareAlt, BiTrash, BiEditAlt, BiHide, BiShow } from "react-icons/bi";
                            ...
                            {isOwner ? (
                                <>
                                    ...
                                    <button
                                        ...
                                        className="w-[calc(100%-12px)] mx-1.5 px-2.5 py-1.5 text-left text-[13px] font-semibold flex items-center gap-2.5 hover:bg-amber-50 dark:hover:bg-amber-900/20 text-gray-700 dark:text-gray-200 rounded-xl transition-all duration-200 group"
                                    >
                                        <div className="p-1 rounded-lg bg-amber-50 dark:bg-amber-900/30 text-amber-500 group-hover:bg-amber-500 group-hover:text-white transition-colors">
                                            {status === "archived" ? <BiShow size={14} /> : <BiHide size={14} />}
                                        </div>
                                        {status === "archived" ? "Make Public" : "Hide Paper"}
                                    </button>
